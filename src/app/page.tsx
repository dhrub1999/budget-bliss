...
export default async function Page() {
  return (
    <div className='min-h-screen overflow-x-hidden overflow-y-auto bg-[#1E1E1E] text-white'>
      ...
      {/* Hero Section */}
      <section className='relative z-10 mx-auto flex max-w-7xl flex-col items-center px-6 pt-20 pb-16 text-center md:pt-32 md:pb-24'>
        ...
        <h1 className='font-nunito mb-6 max-w-4xl text-4xl leading-tight font-extrabold tracking-tight text-white sm:text-5xl md:text-7xl'>
          ...
          <span className='from-brand-400 via-brand-500 bg-gradient-to-r to-green-300 bg-clip-text text-transparent'>
            Effortlessly.
          </span>
        </h1>

        <p className='font-nunito mb-10 max-w-2xl text-lg leading-relaxed text-neutral-400 md:text-xl'>
          Track expenses, build customized budgets, and visually analyze your
          investments in a beautiful, unified dashboard designed to reduce
          financial stress.
        </p>
