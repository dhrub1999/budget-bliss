          ...
          <DialogBody className='space-y-4 pt-2 pr-1'>
            ...
            <div className='space-y-1.5'>
              ...
              <Input
                ...
                required
                autoFocus
                className='h-12 w-full rounded-xl border-zinc-800/80 bg-[#18181b] px-4 text-white placeholder:text-zinc-500 focus-visible:border-emerald-500 focus-visible:ring-1 focus-visible:ring-emerald-500'
              />
            </div>
